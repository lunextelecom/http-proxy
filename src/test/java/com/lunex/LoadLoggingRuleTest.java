...
public class LoadLoggingRuleTest {
  ...
  public void testRegex() {
    ...
    assertEquals(true, Configuration.getProxyRule().getRoutes().get(1).getLoggings().get(ELoggingOption.req_body) != null);
    assertEquals(true, Configuration.getProxyRule().getRoutes().get(2).getLoggings().get(ELoggingOption.resp_body) != null);
  ...
  public void testVerd() {
    ...
    assertEquals(true, Configuration.getProxyRule().getRoutes().get(2).getLoggings().get(ELoggingOption.resp_body).getVerbs().contains(EVerb.POST));
  }
