...
public class HttpProxyAdminServerHandler extends SimpleChannelInboundHandler<HttpObject> {
  ...
  private AdminFunction function = null;
  ...
  public void channelReadComplete(ChannelHandlerContext ctx) {
    // write response
    if (function == AdminFunction.EXCEPTION) {
    ...
    if(function == AdminFunction.CHECKHEALTH){
      content = "OK";
    }else if(function == AdminFunction.MONITOR){
